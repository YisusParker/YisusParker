...
I'm a Data Scientist building end-to-end solutions that turn complex data into actionable insights. I specialize in Python-based ETL pipelines, NLP models, and interactive visualizations, while also developing production web apps with React and Next.js.

**What I do:**
- 🔄 Design automated data pipelines and workflows
- 🤖 Build machine learning models for real-world applications
- 📊 Create interactive dashboards with Tableau, Power BI, and Streamlit
...
### 🌐 Socials
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/jesusdavidmontilla/) [![Medium](https://img.shields.io/badge/Medium-12100E?logo=medium&logoColor=white)](https://medium.com/@jesusarevalomontilla)
